...
curl http://localhost:11434/api/generate -d '{
  ...
  "options": {
    ...
    "stop": ["\n", "user:"],
    "numa": false,
    "num_ctx": 1024, # DEPRECATED: This parameter is now effectively ignored.
    "num_batch": 2,
    "num_gpu": 1,
    "main_gpu": 0,
    "use_mmap": true,
...
```json5
{
  "modelfile": "# Modelfile generated by \"ollama show\"\n# To build a new Modelfile based on this one, replace the FROM line with:\n# FROM llava:latest\n\nFROM /Users/matt/.ollama/models/blobs/sha256:200765e1283640ffbd013184bf496e261032fa75b99498a9613be4e94d63ad52\nTEMPLATE \"\"\"{{ .System }}\nUSER: {{ .Prompt }}\nASSISTANT: \"\"\"\n# PARAMETER num_ctx 4096 # DEPRECATED: This parameter is now effectively ignored.\nPARAMETER stop \"\u003c/s\u003e\"\nPARAMETER stop \"USER:\"\nPARAMETER stop \"ASSISTANT:\"",
...
- `options`: additional model parameters listed in the documentation for the [Modelfile](./modelfile.md#valid-parameters-and-values) such as `temperature`. Note that `num_ctx` is now deprecated and effectively ignored.
- `keep_alive`: controls how long the model will stay loaded into memory following the request (default: `5m`)
